		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<table class="table table-hover">
					<!-- bootstrap은 border을 주지않고 클래스를 주면됨 -->
					<tr>
						<td>번호</td>
						<td>제목</td>
						<td>조회수</td>
				...
				<br> <br>
				<div>
					<form action="${cpath}/boardSerch.do" method = "post">
						<table class="table">
							<tr>
				...
				<button class="btn btn-primary btn-sm" onclick="goJson()">JSON
					DATA 가져오기(Ajax)</button>
